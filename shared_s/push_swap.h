...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/26 17:20:28 by ahalmon-          #+#    #+#             */
/*   Updated: 2019/07/26 18:22:05 by ahalmon-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						structure_filler_ps(t_list *arguments, \
	t_stacks *stacks);
...
size_t					is_sorted_shift_in_mind_ps(int *ints, \
	size_t size, int new);
